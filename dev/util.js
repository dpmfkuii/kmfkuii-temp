...
const path_relative = (...paths) =>
    path.relative(path_resolve("../"), ...paths);
const public_path = path_resolve("../public");

const is_prod = process.argv.includes("--prod");

const log = (color_code, pre, content, ...misc) =>
    console.log(`\x1b[${color_code}m%s\x1b[0m %s`, pre, content, ...misc);
